...
const quizTypes = [
  { id: 'listen-and-choose', label: '소리 듣고 고르기', icon: '🔊', bgColor: 'bg-cat-blue', textColor: 'text-blue-600' },
  { id: 'image-to-word', label: '그림 보고 단어 고르기', icon: '🖼️', bgColor: 'bg-cat-green', textColor: 'text-green-600' },
  { id: 'first-sound', label: '첫 소리 맞추기', icon: '🔤', bgColor: 'bg-cat-orange', textColor: 'text-orange-600' },
  { id: 'spelling', label: '철자 맞추기', icon: '✏️', bgColor: 'bg-cat-purple', textColor: 'text-purple-600' },
];
